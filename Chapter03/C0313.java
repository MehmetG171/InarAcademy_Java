		...
		if (status < 4) {
			...
			case 1:
				if (income <= 16700) {
					...
					tax = income * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28
							+ (income - 208850) * 0.33;
				} else {
					tax = income * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28
			...
			case 2:
				if (income <= 8350) {
					...
					tax = income * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28
							+ (income - 104425) * 0.33;
				} else {
					tax = income * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28
							+ (372950 - 104425) * 0.33 + (income - 186475) * 0.35;
				}
			...
			case 3:
				if (income <= 11950) {
					...
					tax = income * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28
							+ (income - 190200) * 0.33;
				} else {
					tax = income * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28
